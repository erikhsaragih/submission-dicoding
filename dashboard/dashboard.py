...
all_df = pd.read_csv("https://github.com/erikhsaragih/submission-dicoding/blob/main/dashboard/all_data.csv", on_bad_lines='skip')
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://github.com/erikhsaragih/submission-dicoding/blob/main/dashboard/geolocation.csv', on_bad_lines='skip')
...
with tab3:
    ...
    with st.expander("Penjelasan Geolocation"):
        st.write('Sesuai dengan lokasi pelanggan terbanyak diatas, bahwa banyaknya pelanggan berada di bagian selatan, timur dan tenggara. Informasi banyaknya pelanggan juga berada pada kota-kota yang merupakan ibu kota seperti São Paulo, Rio de Janeiro, Porto Alegre, dan lainnya.')

st.caption('Copyright (C) Erikh Saragih 2023')
